        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown text-end">
                ...
                <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                    <li><a class="dropdown-item active" href="{{ route('student-dashboard') }}"><img src="{{asset('resources/dashboard.png')}}" alt="Dashboard" width="25" height="25" class="mx-2" />Dashboard</a></li>
                    <li><a class="dropdown-item " href="{{ route('scan.qr') }}"><img src="{{asset('resources/qr-code.png')}}" alt="Scan QR" width="25" height="25" class="mx-2" />Scan QR</a></li>
                    ...
                    <li><a class="dropdown-item" href="{{ route('profile.student') }}"><img src="{{asset('resources/user (2).png')}}" alt="Edit Profile" width="25" height="25" class="mx-2" />Edit Profile</a></li>
                    <li>
                        <hr class="dropdown-divider" />
                    </li>
                    <form method="POST" action="{{ route('logout.student') }}">
                        @csrf
                        <li><a class="dropdown-item" href="{{ route('logout.student') }}" onclick="event.preventDefault();
