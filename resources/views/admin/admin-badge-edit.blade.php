        ...
        <form method="post" action="{{route('badge.update',$badge->id)}}">
            ...
            <div class="row">
                <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
                    ...
                    <input type="text" class="form-control" name="Badge_C" value="{{$badge->BadgeCode}}" required>
                </div>
                <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
                    <label>Badge Name</label>
                    <input type="text" class="form-control" name="Badge_N" value="{{$badge->BadgeName}}" required>
                </div>
            </div>
