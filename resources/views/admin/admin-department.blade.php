<header class="p-2 text-bg-primary text-white ">
    <div class="container col-sm-10 col-md-10 col-lg-10 col-xl-10">
        <div class="p-3 d-flex justify-content-center align-items-center">
            <ul class="nav">
                <h4 id="headingId">Department Registration</h4>
            </ul>
        </div>
</header>
        ...
        <form method="post" action="{{route('Department.save')}}">
            ...
            <div class="row">
                <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
                    ...
                    <input id="deptId" type="text" class="form-control" name="Department_C" autofocus required>
                </div>
                <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
                    <label>Department Name</label>
                    <input id="deptName" type="text" class="form-control" name="Department_N" required>
                </div>
            </div>
