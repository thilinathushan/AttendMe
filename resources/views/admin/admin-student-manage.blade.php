...
<div class="container mx-auto mt-4 col-sm-12 col-md-12 col-lg-12 col-xl-12">
    ...
    <div class="wrapper rounded">
        <form id="formStuManage" method="get">
            @csrf
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="sidebar">
                                    <a class="btn btn-primary menu my-2" href="{{ route('student.edit', $post->id) }}" role="button">Edit</a>
                                </div>
                                <a class="btn btn-danger menu" href="{{route( 'student.delete', $post->id)}}" role="button">Delete</a>
    ...
    $(document).ready(function() {
        ...
        $('#activeAllBtn, #inactiveAllBtn, #deleteAllBtn').click(function() {
            ...
            if (this.id === 'activeAllBtn') {
                action = "{{ route('student.allactive') }}";
            } else if (this.id === 'inactiveAllBtn') {
                action = "{{ route('student.allinactive') }}";
            } else if (this.id === 'deleteAllBtn') {
                action = "{{ route('student.alldelete') }}";
            }

            // Set the form action dynamically
            $('#formStuManage').attr('action', action);
        });
    });
</script>