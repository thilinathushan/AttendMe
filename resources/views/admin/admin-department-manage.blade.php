...
<div class="container mx-auto mt-4 col-sm-12 col-md-12 col-lg-12 col-xl-12">
    ...
    <div class="wrapper rounded">
        <form method="get" action="{{ route('department.alldelete') }}">
            @csrf
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$post->id}}</td>
                            <td>{{$post->DepartmentCode}}</td>
                            <td>{{$post->DepartmentName}}</td>
                            <td>{{$post->updated_at}}</td>
                            <td>
                                <div class="sidebar">
                                    <a class="btn btn-primary menu my-2" href="{{route( 'department.edit', $post->id)}}" role="button">Edit</a>
                                </div>
                                <a class="btn btn-danger" href="{{route( 'department.delete', $post->id)}}" role="button">Delete</a>
