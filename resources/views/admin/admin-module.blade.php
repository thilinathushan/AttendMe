...
<div class="container mx-auto mt-4 col-sm-10 col-md-10 col-lg-10 col-xl-10">
    <div class="wrapper rounded">
        <form method="post" action="{{route('Moduler.save')}}">
            @csrf
            <div class="row">
                <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
                    <label>Module Code</label>
                    <input type="text" class="form-control" name="Module_C" autofocus required>
                </div>
                <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
                    <label>Module Name</label>
                    <input type="text" class="form-control" name="Module_N" required>
                </div>
            </div>
