<form method="post" action="{{ route('update.student.profile',Auth::user()->id) }}" class="mt-6 space-y-6">
    @csrf
    @method('put')
    ...
    <div class="row">
        <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
            ...
            <div class="input-group">
                <input name="email" type="email" value="{{ Auth::user()->email }}" id="email" class="form-control" placeholder="Student's username" aria-label="Student's username" aria-describedby="basic-addon2">
    ...
    <div class="row">
        <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
            <label>Badge</label>
            <select name="badge" class="form-select" aria-label="Default select example">
                <option value="{{Auth::user()->badge}}" selected>{{Auth::user()->badge}}</option>
        ...
        <div class="col-md-6 mt-md-3 mt-lg-3 mt-3">
            ...
            <div class="d-flex align-items-center mt-2">
                <div class="form-check">
                    <input name="gender" type="radio" class="form-check-input" id="radio1" name="gender" value="Male" {{ Auth::user()->gender === 'Male' ? 'checked' : '' }}>Male
                    <label class="form-check-label" for="radio1"></label>
                </div>
                <div class="form-check">
                    <input name="gender" type="radio" class="form-check-input" id="radio2" name="gender" value="Female" {{ Auth::user()->gender === 'Female' ? 'checked' : '' }}>Female
